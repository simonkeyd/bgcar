...
class Buttons(object):
    class Store:
        def __init__(self):
            ...
            self.position = Buttons.get_pos(self.description)
    ...
    class Total_roll:
        def __init__(self):
            ...
            self.top_left_position = Buttons.get_pos(self.top_left_description)
            self.bottom_right_description = self.description + " bottom right"
            self.bottom_right_position = Buttons.get_pos(self.bottom_right_description)
    ...
    def init_settings(self):
        ...
        self.total_roll = self.Total_roll()
    ...
    def read_settings(self, config_filename="config.json"):
        ...
        try:
            ...
            err_console.print(
                "(ERROR) [default]Config file '{0}' not found. Please initialize settings using '-i' parameter.".format(
                    config_filename
                )
            )
            sys.exit(1)
